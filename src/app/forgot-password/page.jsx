...
const ForgotPassword = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            const loading = toast.loading("Đang gửi mã xác thực đến email của bạn")
            try {
                await UserService.checkEmail(values.email);
                ...
                await EmailService.sendCode(params)
                toast.success("Gửi thành công", {
                    id: loading
                })
                router.push(`/recover-password?email=${values.email}`)
            } catch (error) {
